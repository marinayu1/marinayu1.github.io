...
// Update time
  function update() {
    ...
    function checkHalfMinute(momentMinute){
      if (momentMinute < 5) {halfMinute = 'twelfthH';}
      else if (momentMinute < 10) {halfMinute = 'sixthH';}
      else if(momentMinute < 15) {halfMinute = 'quarterH';}
      else if(momentMinute < 20) {halfMinute = 'thirdH';}
      else if(momentMinute < 30){halfMinute = 'halfH';}
      else if(momentMinute < 45){halfMinute = 'threequatersH';}
