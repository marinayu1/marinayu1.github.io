...
// Update time
  function update() {
    ...
    function checkHalfMinute(momentMinute){
      if (momentMinute < 5) {halfMinute = 'fiveM';}
      else if (momentMinute < 10) {halfMinute = 'tenM';}
      else if(momentMinute < 15) {halfMinute = 'quarterM';}
      else if(momentMinute < 20) {halfMinute = 'twentyM';}
      else if(momentMinute < 25) {halfMinute = 'twentyfiveM';}
